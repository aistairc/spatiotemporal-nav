...
### Examples
- Execute 2D-A* for scene 000 with the above demo video setup. The -i option must be specified to use the current information. Since no future information is used, Dataset1 and 2 will have the same result. 
```bash
...
|   ...
|   |
│   └── origin      (Current pedestrians' maps of the whole 000 scene)
│       ├── 000.png
|       ...
│       └── 899.png
...
