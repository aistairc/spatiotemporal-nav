...
- [For 2D-A* and proposed method](data.airc.aist.go.jp/dense_crowds_dataset/50pedestrians_50scenes.tar.xz)
- [For proposed method with true trajectory(94MB)](data.airc.aist.go.jp/dense_crowds_dataset/50pedestrians_50scenes_true_trajectory.tar.xz)
